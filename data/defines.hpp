...
class RscMapControl
{
  ...
  colorRailWay[] = {0.6, 0.45, 0.35, 1.00};
  colorTracks[] = {0.8, 0.45, 0.35, 1.00};
  colorTracksFill[] = {1, 0.45, 0.35, 1.00};
  colorRoads[] = {0.3, 0.3, 0.3, 1.00};
  colorRoadsFill[] = {0.4, 0.4, 0.4, 1.00};
  colorMainRoads[] = {0.1, 0.1, 0.1, 1.00};
  colorMainRoadsFill[] = {0.2, 0.2, 0.2, 1.00};
  colorGrid[] = {0.65, 0.45, 0.35, 1.00};
  colorGridMap[] = {0.6, 0.45, 0.35, 1.00};
