/*
	...
	Description: Simplifies marker creation to one line, using parameters. This is the shape types version.
	...
	Example: 
		Example 1: ["respawn_west",(position player),"RECTANGLE","Grid","ColorBlack",[50,50]] call fnc_createMarkerShape;
